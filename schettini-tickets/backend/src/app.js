...
const settingsTermsRoutes = require('./routes/settingsTermsRoutes');
const moduleRoutes = require('./routes/moduleRoutes');
const chatRoutes = require('./routes/chatRoutes');
const resourceRoutes = require('./routes/resourceRoutes');
const resourceSectionRoutes = require('./routes/resourceSectionRoutes');
const kbFolderRoutes = require('./routes/kbFolderRoutes');
...
const { adminRouter: systemFormAdminRoutes, clientRouter: systemFormClientRoutes } = require('./routes/systemFormRoutes');
...
app.use('/api/settings', settingsTermsRoutes);
app.use('/api/modules', moduleRoutes);
app.use('/api/chat', chatRoutes);
app.use('/api/resources', resourceRoutes);
app.use('/api/resource-sections', resourceSectionRoutes);
app.use('/api/kb-folders', kbFolderRoutes);
...
app.use('/api/admin/forms', systemFormAdminRoutes);
app.use('/api/client/forms', systemFormClientRoutes);
